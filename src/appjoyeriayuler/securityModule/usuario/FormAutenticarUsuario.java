...
public class FormAutenticarUsuario extends javax.swing.JFrame {
    
    public FormAutenticarUsuario() {
        initComponents();        
        setResizable(false);
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        ControlAutenticarUsuario controlador = new ControlAutenticarUsuario();
        boolean resultado = controlador.autenticarUsuario(usuario, password); // ✅ guardar el retorno
